...
def configure_logging(debug=False):
    ...
    logger.debug(
        "Debug mode enabled: Verbose logging activated." if debug else "Logging set to INFO level."
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mcp", action="store_true", help="Enable the MCP server for tool usage")
